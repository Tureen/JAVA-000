package club.tulane.customgateway.outbound.demo;

import club.tulane.customgateway.outbound.HttpOutboundHandler;
...
public class DemoHttpOutboundHandler implements HttpOutboundHandler {

    private CloseableHttpAsyncClient httpclient;
    private String backendUrl;
    private ExecutorService proxyService;

    public DemoHttpOutboundHandler(String backendUrl) {
